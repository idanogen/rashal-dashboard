...
function DialogContent({
  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      >
        {children}
        {/* 🔴 כפתור הסגירה יושב על `end-4` ולא על `right-4`. הכל כאן RTL,
            ולכן הפינה הפיזית הימנית היא המקום שבו **מתחילה הכותרת**,
            והכפתור ישב בדיוק על האייקון שלה. אינסט לוגי מעביר אותו
            לפינה החופשית, ומתהפך מעצמו אם מסך כלשהו יהיה LTR. */}
        {showCloseButton && (
