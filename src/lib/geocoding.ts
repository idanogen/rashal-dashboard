...
const CITY_COORDINATES: Record<string, Coordinates> = {
  ...
  'טייבה': { lat: 32.2667, lng: 35.0167 },
  'טירה': { lat: 32.2333, lng: 34.9500 },
  'קלנסווה': { lat: 32.2833, lng: 35.0167 },

  // ─── רחובות-נס ציונה ──────────────────────────────
  'ראשון לציון': { lat: 31.9730, lng: 34.7925 },
  'רחובות': { lat: 31.8947, lng: 34.8081 },
  'נס ציונה': { lat: 31.9306, lng: 34.7992 },
  'קרית עקרון': { lat: 31.8694, lng: 34.8181 },
  'קריית עקרון': { lat: 31.8694, lng: 34.8181 },
  'מזכרת בתיה': { lat: 31.8567, lng: 34.8347 },
